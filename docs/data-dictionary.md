...
| Tabel | Kolom | Tipe Data | Constraint | Keterangan |
|-------|-------|-----------|------------|------------|
| Forum_Balasan | id_forum_balasan | INT | PK, AUTO_INCREMENT | ID unik setiap komentar |
| Forum_Balasan | id_topik | INT | FK → Forum_Topik.id_topik ON DELETE CASCADE | Topik yang ingin dibalas |
| Forum_Balasan | id_user | INT | FK → Users.id_user | Pengguna yang membalas |
