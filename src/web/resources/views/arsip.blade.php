  ...
  <div class="main-content">
    ...
    <main class="page-scroll">
      ...
      <div class="arsip-header">
        <div class="arsip-title-row">
          <svg class="arsip-icon" viewBox="0 0 24 24">
            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>
          </svg>
          <h1 class="arsip-title">ARSIP</h1>
        </div>
        <p class="arsip-subtitle">Kumpulan dokumen mata kuliah</p>
        <hr class="arsip-divider" />
      </div>
...
<script src="{{ asset('script/arsip.js') }}"></script>
</body>
</html>