...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('unggah.admin') }}" class="nav-item active" data-page="unggah">
                <div class="nav-item-left">
    ...
    <div class="main-content">
        ...
        <main class="page-scroll">
            ...
            {{-- =============================== --}}
            {{-- VIEW 1: DAFTAR REVIEW UNGGAHAN  --}}
            {{-- =============================== --}}
            <section id="unggah-admin-view" class="page-view-container">
                ...
                <div class="unggah-page-header">
                    <div class="unggah-header-left">
                        ...
                        <p class="unggah-subtitle">Review & Approval</p>
                    </div>
                    ...
                    <table class="unggah-table">
                        ...
                        <tbody>
                            @isset($dokumen)
                                ...
                                <tr class="table-row-clickable" onclick="window.location='{{ route('unggah.review', $d->id_dokumen) }}'">
                                    <td class="td-filename">{{ $d->judul_file }}</td>
                                    <td>{{ $d->nama_matkul }}</td>
                                    <td>{{ \Carbon\Carbon::parse($d->created_at)->format('d-m-Y') }}</td>
                                    <td>
                                        <span class="status-badge status-{{ strtolower($d->status) }}">
                                            {{ $d->status == 'menunggu' ? 'Menunggu Review' : ucfirst($d->status) }}
                                        </span>
                                    </td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="4" class="td-empty">Belum ada file yang diunggah.</td>
                                </tr>
                                @endforelse
                            @else
                            <tr>
                        ...
                        <div class="form-row-two">
                            <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                    ...
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="select-caret"><polyline points="6 9 12 15 18 9"/></svg>
                                </div>
                            </div>
                            <div class="form-group">
